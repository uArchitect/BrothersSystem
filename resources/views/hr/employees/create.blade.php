                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="text-primary mb-1"><i class="fal fa-user-plus mr-2"></i>Yeni Personel Oluştur</h4>
                                <p class="text-muted mb-0">Personel bilgilerini tab'lar üzerinden doldurun</p>
                            </div>
                            <div>
                        ...
                        <!-- Form -->
                        <form action="{{ route('employees.add') }}" method="POST" enctype="multipart/form-data" id="employeeForm">
                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                                              ...
                                                              placeholder="Adres bilgisi">{{ old('address') }}</textarea>
                                                    @error('address')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('tc_no') is-invalid @enderror" 
                                                           id="tc_no" name="tc_no" value="{{ old('tc_no') }}" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('sgk_no') is-invalid @enderror" 
                                                           id="sgk_no" name="sgk_no" value="{{ old('sgk_no') }}" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('working_days_per_month') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('working_days_per_month', 30) }}" min="1" max="31" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('monthly_salary') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('monthly_salary') }}" step="0.01" min="0" 
                                                           placeholder="0.00">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('weekly_wage') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('weekly_wage') }}" step="0.01" min="0" 
                                                           placeholder="0.00">
                                                    @error('weekly_wage')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('daily_wage') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('daily_wage') }}" step="0.01" min="0" 
                                                           placeholder="0.00">
                                                    @error('daily_wage')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('hourly_wage') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('hourly_wage') }}" step="0.01" min="0" 
                                                           placeholder="0.00">
                                                    @error('hourly_wage')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-success btn-lg">
                                    <i class="fal fa-save mr-2"></i> Personel Oluştur
                                </button>
...
(function() {
    ...
    function isFieldVisible(field) {
        ...
        // Display style kontrolü
        const style = window.getComputedStyle(field);
        if (style.display === 'none' || style.visibility === 'hidden') {
            return false;
        }
        
        // Parent elementlerin görünürlüğünü kontrol et
        ...
        // Wage field kontrolü - sadece görünür olan wage field'lar geçerli
        ...
        // Tab pane kontrolü - aktif tab içinde mi?
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                if (!form.checkValidity()) {
                    ...
                    // Tüm geçersiz alanları bul
                    const invalidFields = checkInvalidFields(form);
                    
                    if (invalidFields.length > 0) {
                        // İlk geçersiz alanı göster
...
(function() {
    function initEmployeeForm() {
        ...
        jQuery(document).ready(function($) {
                ...
                if (groupId) {
                    $.ajax({
                        ...
                        success: function(positions) {
                            ...
                            // Mevcut görevleri badge'ler halinde göster
                            if (positions.length > 0) {
                                ...
                                positions.forEach(function(position) {
                                    ...
                                    html += '<span class="badge badge-primary p-2 position-badge" style="cursor: pointer; transition: all 0.3s;" data-position-id="' + position.id + '" data-position-name="' + position.name + '">';
                                    html += '<i class="fal fa-user-tag mr-1"></i>' + position.name;
                                    html += '</span>';
                                    html += '</div>';
                                });
                                ...
                                // Badge'lere tıklama eventi ekle
            ...
            // Sayfa yüklendiğinde varsayılan periyodu göster
            var defaultFrequency = $('input[name="payment_frequency"]:checked').val() || 'monthly';
            $('input[name="payment_frequency"][value="' + defaultFrequency + '"]').trigger('change');
            ...
            // IBAN - format kontrolü yok, serbest giriş
        });
    }
