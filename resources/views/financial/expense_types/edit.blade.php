                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="expense-type-form">
                            <form method="POST" action="{{ route('expense_types.update', $expenseType->id) }}">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                       id="name" name="name" value="{{ old('name', $expenseType->name) }}" 
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Gider tipi açıklaması...">{{ old('description', $expenseType->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
