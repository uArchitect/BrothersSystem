                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="income-category-form">
                            <form method="POST" action="{{ route('income_categories.update', $incomeCategory->id) }}">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                       id="name" name="name" value="{{ old('name', $incomeCategory->name) }}" 
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Gelir kategorisi açıklaması...">{{ old('description', $incomeCategory->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1"
                                                           {{ old('is_active', $incomeCategory->is_active) ? 'checked' : '' }}>
