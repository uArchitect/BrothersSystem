            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <form method="POST" action="{{ route('customers.transactions.store', $customer->id) }}">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('type') is-invalid @enderror" 
                                            ...
                                            <option value="Gelir" {{ old('type') == 'Gelir' ? 'selected' : '' }}>Gelir</option>
                                            <option value="Gider" {{ old('type') == 'Gider' ? 'selected' : '' }}>Gider</option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Hareket açıklaması">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
